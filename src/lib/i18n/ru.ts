...
const ru: Dictionary = {
  ...
  route: {
    ...
    trafficPointsTooltip: 'Точек измерения трафика на этом участке: {n} — не подтверждено по GPS',
  ...
  mapPopup: {
    ...
    estimatedTrainNoSignal: 'Оценка по расписанию — поезд сейчас не передаёт GPS-позицию',
    liveGps: 'GPS в реальном времени',
  ...
  fare: {
    ...
    profileSenior: 'Пенсионер',
    residentOf: 'Зарегистрированный житель города',
  },
}

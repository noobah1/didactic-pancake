...
export async function GET(request: Request) {
  ...
  // For localhost/development, return mock route geometry
  if (OTP_BASE_URL.includes('localhost') || OTP_BASE_URL === 'http://localhost:3000') {
    const mockGeometry = '59.43,24.75;59.44,24.76;59.45,24.77;59.46,24.78;59.47,24.79'
      ...
      patterns: [
        {
          ...
          stops: [
            { name: 'Kaunas jaam', lat: 59.43, lng: 24.75 },
            { name: 'Viru keskus', lat: 59.44, lng: 24.76 },
            { name: 'Balatoni tn', lat: 59.45, lng: 24.77 },
            { name: 'Gonsiori tn', lat: 59.46, lng: 24.78 },
            { name: 'Jätkuu tn', lat: 59.47, lng: 24.79 },
          ],
        },
      ],
    })
